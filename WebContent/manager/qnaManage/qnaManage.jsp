<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.*, Qna.model.*, Member.model.vo.*"%>
<%
				...
				<div class="content-wrap">
					...
					<div class="tableArea">
						<table id="table">
							...
							<tr>
								<td><%=q.getOnum()%></td>
								<td><a href="<%=request.getContextPath()%>/qnadetailman.qt?qnum=<%=q.getOnum()%>"><%=q.getOtitle()%></a></td>
								<td><%=q.getOdate()%></td>
								<td><%=q.getOstatus()%></td>
							</tr>
							<%
						...
						<div class="pagingArea" align="center">
							<!--  맨 처음으로 (<<) -->
							<a href="<%=contextPath%>/qnalist.ql?currentPage=1"
							...
							%>
							<a
								href="<%=contextPath%>/qnalist.ql?currentPage=<%=currentPage - 1%>"
								class="button button-light bgcolor-grey-light button-rounded button-reveal button-small button-3d tright"><i
							...
							%>
							<a href="<%=contextPath%>/qnalist.ql?currentPage=<%=maxPage%>"
								class="button button-light bgcolor-grey-light button-rounded button-reveal button-small button-3d tright"><i
