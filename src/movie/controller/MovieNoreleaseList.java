...
public class MovieNoreleaseList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Movie> mlist = bService.selectList(2,currentPage,boardLimit);
		...
		if(mlist !=null && mplist !=null) {
			...
			request.getRequestDispatcher("views/movie/MovieNoReleaseListViewForm.jsp").forward(request, response);
