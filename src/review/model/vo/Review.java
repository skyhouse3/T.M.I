...
public class Review implements java.io.Serializable{
	private static final long serialVersionUID = 8882887100257086956L;
	...
	public Review(String rnum, String mcode, String rtitle, String rWriter, String rcontent, String rrate,
	...
	public Review(String rnum, String rtitle, String rrate, Date mrvDate) {
		super();
		Rnum = rnum;
		Rtitle = rtitle;
		Rrate = rrate;
	...
	public Review(String rnum, String mcode, String rtitle, String rrate, Date mrvDate) {
		super();
		Rnum = rnum;
		Mcode = mcode;
		Rtitle = rtitle;
	...
	public Review(String mcode, String rtitle, String rcontent, String rrate, String charmingPoint,
			String director_production, String oST, String action_acting, String story, String movie_beauty) {
		super();
		Mcode = mcode;
		Rtitle = rtitle;
		Rcontent = rcontent;
